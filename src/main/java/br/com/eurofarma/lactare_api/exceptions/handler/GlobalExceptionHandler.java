package br.com.eurofarma.lactare_api.exceptions.handler;
...
import br.com.eurofarma.lactare_api.exceptions.dto.CustomErrorDTO;
import br.com.eurofarma.lactare_api.exceptions.dto.ValidationErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomErrorDTO> handleTypeMismatch(
        ...
        CustomErrorDTO err = new CustomErrorDTO(
                Instant.now(),
                status.value(),
                "Parâmetro inválido. O ID deve ser um número.",
                request.getRequestURI()
        );
